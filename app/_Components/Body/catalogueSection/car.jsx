  ...
  return (
    <>
      ...
      >
        {filteredModel.map((item, index) => (
          ...
          >
            ...
            <div
              id="img_container"
              className="w-full md:h-64 lg:h-60 h-48 relative"
            >
      ...
      {allModels && (
        <div
          id="all_cars"
          className={`container gap-x-4 sm:gap-y-8 gap-y-12  grid justify-between ${itemWidthClass}`}
        >
          {manufacturer.slice(0, visibleItems).map((item, index) => (
            <div
              id="car"
              key={index}
              className={`p-4 px-7 mx-auto bg-gray-100 w-full rounded-xl group transition hover:bg-white hover:shadow-lg`}
            >
              ...
              >
                <div className="relative">
                  <span className="mx-auto sm:text-base text-sm">
                    View More{" "}
                  </span>
                  <div className="absolute  w-[22px] left-[95%] top-[50%] transform translate-y-[-50%]">
                    <Image
          ...
          {manufacturer.length > visibleItems && (
            <button
